...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/plain_notification_token_for_us/plain_notification_token_for_us.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/tencent_chat_push_for_china/tencent_chat_push_for_china.framework"
fi
